...
export default function LandingPage() {
  ...
  const [salons, setSalons] = useState<any[]>([]); // 👈 Store fetched salons here
  const [loading, setLoading] = useState(true);

  // 👇 NEW: Fetch salons from backend on load
  useEffect(() => {
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="relative max-w-lg mx-auto group">
                <input 
                    ...
                    className="w-full p-5 pl-14 bg-white/5 border border-white/10 rounded-2xl text-white outline-none focus:border-green-500/50 focus:bg-black/80 transition-all backdrop-blur-md relative z-10 shadow-2xl"
                    value={search}
